...
class FCN_LectureNet(nn.Module):
    ...
    @staticmethod
    def CreateFromConfig(in_channels, reconstruction_mode):
        n_convs_down_1 = 48 #config.get("FCN_BINARIZER_NET_DOWN_CONV_FILTERS_1", 16)
        n_convs_down_2 = 96 #config.get("FCN_BINARIZER_NET_DOWN_CONV_FILTERS_2", 32)
        n_convs_down_3 = 192 #config.get("FCN_BINARIZER_NET_DOWN_CONV_FILTERS_3", 64)
        n_convs_down_4 = 384 #config.get("FCN_BINARIZER_NET_DOWN_CONV_FILTERS_4", 128)
        n_convs_down_5 = 768 #config.get("FCN_BINARIZER_NET_DOWN_CONV_FILTERS_5", 256)

        n_convs_mid = 768 #config.get("FCN_BINARIZER_NET_MIDDLE_CONV_FILTERS_MIDDLE", 512)

        n_upscale_5 = 384 #config.get("FCN_BINARIZER_NET_UPSAMPLE_FILTERS_5", 256)
        n_convs_up_5 = 384 #config.get("FCN_BINARIZER_NET_UP_CONV_FILTERS_5", 256)

        n_upscale_4 = 192 #config.get("FCN_BINARIZER_NET_UPSAMPLE_FILTERS_4", 128)
        n_convs_up_4 = 192 #config.get("FCN_BINARIZER_NET_UP_CONV_FILTERS_4", 128)

        n_upscale_3 = 96 #config.get("FCN_BINARIZER_NET_UPSAMPLE_FILTERS_3", 64)
        n_convs_up_3 = 96 #config.get("FCN_BINARIZER_NET_UP_CONV_FILTERS_3", 64)

        n_upscale_2 = 48 #config.get("FCN_BINARIZER_NET_UPSAMPLE_FILTERS_2", 32)
        n_convs_up_2 = 48 #config.get("FCN_BINARIZER_NET_UP_CONV_FILTERS_2", 32)

        n_upscale_1 = 32 #config.get("FCN_BINARIZER_NET_UPSAMPLE_FILTERS_1", 16)
        n_convs_up_1 = 32 #config.get("FCN_BINARIZER_NET_UP_CONV_FILTERS_1", 16)

        n_pix_feats_1 = 32 #config.get("FCN_BINARIZER_NET_PIXEL_FEATURES_1", 32)
        n_pix_feats_2 = 16 #config.get("FCN_BINARIZER_NET_PIXEL_FEATURES_2", 16)

        pix_kernel_size = 7 #config.get("FCN_BINARIZER_NET_PIXEL_KERNEL_SIZE", 3)

        kernel_size = 3 #config.get("FCN_BINARIZER_NET_KERNEL_SIZE", 3)
